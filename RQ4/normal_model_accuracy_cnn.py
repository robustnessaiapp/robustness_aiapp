...
def main():
    ...
    write_result(str(bim_score) + '>' + 'bim_score', 'normal_model_acc_cnn.txt')
    write_result(str(pgd) + '>' + 'pgd', 'normal_model_acc_cnn.txt')
    write_result(str(sa) + '>' + 'sa', 'normal_model_acc_cnn.txt')
    write_result(str(fsgm) + '>' + 'fsgm', 'normal_model_acc_cnn.txt')
    write_result(str(newf) + '>' + 'newf', 'normal_model_acc_cnn.txt')
    write_result(str(patch) + '>' + 'patch', 'normal_model_acc_cnn.txt')
    write_result(str(normal_score)+'>'+'normal_score', 'normal_model_acc_cnn.txt')
