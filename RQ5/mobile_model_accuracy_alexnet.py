...
def main():
    ...
    write_result(str(bim_score) + '>' + 'bim_score', 'mobile_model_acc_alexnet.txt')
    write_result(str(pgd) + '>' + 'pgd', 'mobile_model_acc_alexnet.txt')
    write_result(str(sa) + '>' + 'sa', 'mobile_model_acc_alexnet.txt')
    write_result(str(fsgm) + '>' + 'fsgm', 'mobile_model_acc_alexnet.txt')
    write_result(str(newf) + '>' + 'newf', 'mobile_model_acc_alexnet.txt')
    write_result(str(patch) + '>' + 'patch', 'mobile_model_acc_alexnet.txt')
    write_result(str(mobile_score)+'>'+'mobile_score', 'mobile_model_acc_alexnet.txt')
